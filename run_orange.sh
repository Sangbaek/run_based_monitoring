...
out_monitor=(CVT_trks)
out_FT=(FTH_MIPS_time)
cd groovy_output
#for name in out_monitor dst_mon out_CND out_HTCC out_TOF out_CTOF
out_monitor=(EC_pim_time EC_pip_time)
...
do
	...
	do
		#$groovy ../groovy_codes/$script.groovy `find /volatile/clas12/rga/pass0/monitoring/plots* -name "$name*"` #rga
		 $groovy ../groovy_codes/$script.groovy `find /work/clas12/rg-b/offline_monitoring/plots{6296,6302,6335,6363,6383,6426,6445,6476,6489,6501,6523,6524} -name "$name*"` #rgb
