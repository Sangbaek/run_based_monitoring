...
def grtl = (1..6).collect{
  ...
  gr.setTitle("FTOF time per sector, p1b electron, mean")
  gr.setTitleY("FTOF time per sector, p1b electron, mean (ns)")
...
def grtl2 = (1..6).collect{
  def gr = new GraphErrors('sec'+it)
  gr.setTitle("FTOF time per sector, p1b electron, sigma")
  gr.setTitleY("FTOF time per sector, p1b electron, sigma (ns)")
  gr.setTitleX("run number")
  return gr
}
