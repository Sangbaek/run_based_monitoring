...
for(arg in args.drop(1)) {
  ...
  (0..<6).each{
    ...
    out.addDataSet(h11)
    grtl[it].addPoint(run, h12.getMean(), 0, 0)
    out.addDataSet(h12)
    grtl[it].addPoint(run, h13.getMean(), 0, 0)
    out.addDataSet(h13)
    grtl[it].addPoint(run, h14.getMean(), 0, 0)
    out.addDataSet(h14)
    grtl[it].addPoint(run, h15.getMean(), 0, 0)
    out.addDataSet(h15)
    grtl[it].addPoint(run, h16.getMean(), 0, 0)
    out.addDataSet(h16)
    // out.addDataSet(f1)
  }
}
