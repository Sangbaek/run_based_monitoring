...
def grtl = (1..6).collect{
  ...
  gr.setTitle("FTOF Vertex Time - RF Time, p1b electron, mean")
  gr.setTitleY("FTOF Vertex Time - RF Time, p1b electron, mean (ns)")
...
def grtl2 = (1..6).collect{
  def gr = new GraphErrors('sec'+it)
  gr.setTitle("FTOF Vertex Time - RF Time, p1b electron, sigma")
  gr.setTitleY("FTOF Vertex Time - RF Time, p1b electron, sigma (ns)")
  gr.setTitleX("run number")
  return gr
}
...
out.writeFile('FTOF_time_p1b_elec_mean.hipo')
out2.writeFile('FTOF_time_p1b_elec_sigma.hipo')
