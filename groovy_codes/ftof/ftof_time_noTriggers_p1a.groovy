...
def close() {
  ...
  ['mean', 'sigma'].each{ name ->
    ...
    (0..<6).each{ sec->
      ...
      grtl.setTitle("p1a Vertex-time difference FTOF_vtime-RFT for pions and electrons without triggers (" + name + ")")
      grtl.setTitleY("p1a Vertex-time difference FTOF_vtime-RFT for pions and electrons without triggers (" + name + ") (ns)")
