...
def grtl = (1..6).collect{
  ...
  gr.setTitle("p1b Path-length Corrected Edep for negative tracks, mid. angles (11, 23 deg)")
  gr.setTitleY("p1b Path-length Corrected Edep for negative tracks, mid. angles (11, 23 deg) (MeV)")
...
for(arg in args) {
  ...
  (0..<6).each{
    def h1 = dir.getObject('/ftof/p1b_edep_midangles_S'+(it+1))
