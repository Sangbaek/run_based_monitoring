...
def close() {
  ...
  ['mean', 'sigma'].each{ name ->
    ...
    (0..<6).each{ sec->
      ...
      grtl.setTitle("p2 Vertex-time difference FTOF_vtime-RFT for pions and electrons (" + name + ")")
      grtl.setTitleY("p2 Vertex-time difference FTOF_vtime-RFT for pions and electrons (" + name + ") (ns)")
