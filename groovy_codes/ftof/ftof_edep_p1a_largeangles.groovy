...
class ftof_edep_p1a_largeangles.groovy {
...
def close() {
  ...
  (0..<6).each{ sec->
    ...
    grtl.setTitle("p1a Path-length Corrected Edep for negative tracks, large angles (>23 deg)")
    grtl.setTitleY("p1a Path-length Corrected Edep for negative tracks, large angles (>23 deg) (MeV)")
