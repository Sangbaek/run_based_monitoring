...
def grtl = (1..6).collect{
  ...
  gr.setTitle("FTOF p1a proton mass^2 peak")
  gr.setTitleY("FTOF p1a proton mass^2 peak (GeV^2)")
...
def grtl2 = (1..6).collect{
  def gr = new GraphErrors('sec'+it)
  gr.setTitle("FTOF p1a proton mass^2 sigma")
  gr.setTitleY("FTOF p1a proton mass^2 (GeV^2)")
  gr.setTitleX("run number")
  return gr
}
...
out.writeFile('FTOF_m2_p1a_prot_mean.hipo')
out2.mkdir('/timelines')
out2.cd('/timelines')
grtl2.each{ out2.addDataSet(it) }
out2.writeFile('FTOF_m2_p1a_prot_sigma.hipo')
