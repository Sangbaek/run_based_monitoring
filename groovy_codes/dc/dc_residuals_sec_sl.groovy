...
for(arg in args) {
  ...
  (0..<6).each{
    ...
    grtl1[it].addPoint(run, f11.getParameter(2), 0, 0)
    out2.addDataSet(h11)
    out2.addDataSet(f11)
    grtl2[it].addPoint(run, f12.getParameter(2), 0, 0)
    out2.addDataSet(h12)
    out2.addDataSet(f12)
    grtl3[it].addPoint(run, f13.getParameter(2), 0, 0)
    out2.addDataSet(h13)
    out2.addDataSet(f13)
    grtl4[it].addPoint(run, f14.getParameter(2), 0, 0)
    out2.addDataSet(h14)
    out2.addDataSet(f14)
    grtl5[it].addPoint(run, f15.getParameter(2), 0, 0)
    out2.addDataSet(h15)
    out2.addDataSet(f15)
    grtl6[it].addPoint(run, f16.getParameter(2), 0, 0)
    out2.addDataSet(h16)
    out2.addDataSet(f16)
