...
def grtl = (1..6).collect{
  ...
  gr.setTitle("FTOF time per sector, p1b pion, mean")
  gr.setTitleY("FTOF time per sector, p1b pion, mean (ns)")
...
def grtl2 = (1..6).collect{
  def gr = new GraphErrors('sec'+it)
  gr.setTitle("FTOF time per sector, p1b pion, sigma")
  gr.setTitleY("FTOF time per sector, p1b pion, sigma (ns)")
  gr.setTitleX("run number")
  return gr
}
