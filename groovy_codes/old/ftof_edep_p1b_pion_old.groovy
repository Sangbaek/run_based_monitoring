...
def grtl = (1..6).collect{
  ...
  gr.setTitle("Mean FTOF edep per sector, p1b pion")
  gr.setTitleY("Mean FTOF edep per sector, p1b pion (MeV)")
...
for(arg in args) {
  ...
  (0..<6).each{
    def h1 = dir.getObject('/FTOF/p1b_pad_edep_pion_S'+(it+1))
...
out.writeFile('ftof_edep_p1b_pion.hipo')
