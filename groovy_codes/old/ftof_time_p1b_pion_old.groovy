...
def grtl = (1..6).collect{
  ...
  gr.setTitle("FTOF Vertex Time - RF Time, p1b pion, mean")
  gr.setTitleY("FTOF Vertex Time - RF Time, p1b pion, mean (ns)")
...
def grtl2 = (1..6).collect{
  def gr = new GraphErrors('sec'+it)
  gr.setTitle("FTOF Vertex Time - RF Time, p1b pion, sigma")
  gr.setTitleY("FTOF Vertex Time - RF Time, p1b pion, sigma (ns)")
  gr.setTitleX("run number")
  return gr
}
...
out.writeFile('ftof_time_p1b_pion_mean.hipo')
out2.writeFile('ftof_time_p1b_pion_sigma.hipo')
