...
#currently we use hipo3 for offline and timeline monitoring
export coatjava='/group/clas12/packages/coatjava/5b.7.6/'
...
out_monitor=(bmtbst/bmt_Occupancy bmtbst/bmt_OnTrkLayers bmtbst/bst_Occupancy bst_OnTrkLayers \
...
ec/ec_Sampl ec/ec_gg_m ec/pip_time ec/pim_time \
...
for name in out_monitor out_TOF out_CTOF out_FT out_HTCC dst_mon
do 
	var=$name[@]
	for script in ${!var}
	do
